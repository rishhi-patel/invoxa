...
import { LayoutDashboard, Users, FileText, CreditCard, Bell, LogOut, Building2, ChevronLeft } from "lucide-react"
      ...
      >
        <div className="flex items-center justify-between h-16 px-6 border-b border-gray-200 dark:border-gray-700">
          <div className="flex items-center space-x-3">
            ...
            <span className="text-xl font-bold text-gray-900 dark:text-white">Invoxa</span>
          </div>
